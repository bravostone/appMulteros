...
export class TareoService {
  url_IndexTareo: string =
    "https://gymsolucionesdev-multeros.azurewebsites.net/api/Tareo/ListarTareo";
  url_InsertTareo: string =
    "https://gymsolucionesdev-multeros.azurewebsites.net/api/Tareo/InsertarTareo";
